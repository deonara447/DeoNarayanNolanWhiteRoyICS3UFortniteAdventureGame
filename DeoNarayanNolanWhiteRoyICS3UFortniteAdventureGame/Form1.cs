    ...
    public partial class Form1 : Form
    {
            ...
            public void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            else if (e.KeyCode == Keys.M)  //blue button press
            {
                ...
                randomNumberHolder1 = randGen.Next(1, 3);
            ...
            switch (scene)
            {
                ...
                case 25:
                    ...
                    blueLabel.Text = "";
                    Thread.Sleep(3000);
                    outputLabel.Text = "The school wifi cuts out and your screen freezes. You don't know what happened, but it's safe to say you died.";
                    yellowLabel.Text = "";
                    redLabel.Text = "Play again";
                    blueLabel.Text = "Exit the game";
                    yellowLabel.Visible = false;
